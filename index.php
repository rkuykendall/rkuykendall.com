...
<html>
  <head>
    <title>Robert Kuykendall - Columbia in NYC</title>
    <meta name="Description" content="Computer Science Masters student at Columbia in NYC.">
  ...
  <body>
    ...
    <section>
      <p>
        ...
        <br /> <a href="Kuykendall-CV.pdf">Resume</a> (pdf), last updated October 2013, and <a href="/design/">design sampling</a>.
      </p>
      ...
      <section>
        ...
        <ul>
          <li><a href="http://simplici7y.com">Simplici7y</a> &mdash; File sharing for the <a href="http://source.bungie.org">Aleph One</a> community. Written in Ruby on Rails in 2007, updated in 2011.</li>
          <li><a href="http://dani365.com/years/2008/months/6">Dani 365</a> &mdash; Photo sharing site and 365 project. Written in Ruby on Rails in 2008.
          <li><a href="http://www.pfhorums.com">The Pfhorums</a> &mdash; Forum for <a href="http://source.bungie.org">Aleph One</a> open source project, founded in 2005.</li>
        </ul>
      </section>
    ...
    <section>
      ...
      <ul>
        ...
        <li>Address &mdash; 135th &amp; Broadway</li>
        <li>AIM &mdash; 
          <script>
            <!--
            // http://rumkin.com/tools/mailto_encoder/custom.php
    ...
    <section style="display: none">
      <h3><a href="https://twitter.com/rkuykendall" style="color: black">I am much better at using Facebook than Twitter.</a></h3>
      <ul>
        <?php // include("./twitter-rss/twitter-rss.php"); ?>
      </ul>
    </section>
    ...
    <script>
      ...
      ga('create', 'UA-11153057-8', 'iwanttohavestevenmoffatsbabies.us');
      ga('send', 'pageview');
