...
<html>
  <head> 
    ...
    <script src="/javascript/mathjax/MathJax.js?config=TeX-AMS_HTML-full"></script>
  ...
  <body>
    ...
    <h3 id="results">Results and Evaluation</h3>
    	...
    	<div class="figure">
    		<embed id="BarGraph100-100" src="figures/BarGraph100-100.svg">
    	...
    	<div class="figure">
    		<embed id="BarGraph92-71" src="figures/BarGraph92-71.svg">
    	...
    	<div class="figure">
    		<embed id="BarGraph13N100O23B21" src="figures/BarGraph13N100O23B21-43_76.9.svg">
    	...
    	<div class="figure">
    		<embed id="BarGraphN70O23B20" src="figures/BarGraphN70O23B20-44.1.svg">
    	...
    	<div class="figure">
    		<embed id="BarGraph40N70O23B20" src="figures/BarGraph40N70O23B20-22.6_55-Simpler.svg">
    ...
    <script type="text/javascript">
		...
		<script type="text/javascript">
		try {
		<p>var pageTracker = _gat._getTracker("UA-11153057-4");</p>
